...
const T = {
  en: {
    ...
    hero_p: "Every post, demo, integration and debate about the System One model on X. Classified by AGK Intelligence and refreshed every hour, with quick checks of active accounts in between, plus a leaderboard of the businesses worth building.",
    ...
    latest: "Latest posts, <em>live</em>", latest_p: "The newest posts about System One on X, refreshed every hour and in quick checks of active accounts in between.",
    ...
    foot_method_txt: "Public posts are collected every hour across the whole network, with quick checks of active accounts in between; videos are transcribed, and each post is classified by AGK Intelligence: type, domain, system pattern, niche and business signals.",
  ...
  fr: {
    ...
    hero_p: "Chaque post, démo, intégration et débat sur le modèle System One sur X. Classé par AGK Intelligence et rafraîchi chaque heure, avec des vérifications rapides des comptes actifs entre deux, et un classement des business à construire.",
    ...
    latest: "Derniers posts, <em>en direct</em>", latest_p: "Les derniers posts sur System One publiés sur X, rafraîchis chaque heure et lors des vérifications rapides des comptes actifs.",
    ...
    foot_method_txt: "Les posts publics sont collectés chaque heure sur tout le réseau, avec des vérifications rapides des comptes actifs entre deux ; les vidéos sont transcrites, et chaque post est classé par AGK Intelligence : type, domaine, système, niche et signaux business.",
